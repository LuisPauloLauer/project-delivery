            ...
            <div class="container-fluid">
                ...
                <div class="row mb-1">
                    <div class="col-lg-auto">
                        <h5>Obs: na consulta padrão são carregados até 1500 kits se precisar use a Pesquisa por filtro.</h5>
                    </div>
                </div>
                <form action="{{ route('kits.search') }}" method="post">
                    ...
                    <div class="row mb-1">
                        ...
                        <div class="col-lg-auto">
                            <a  id="idbtnPesqDefault" style="margin-top: 10px" href="{{ route('kits.pesq', ['pesqdefault' => 'default']) }}" class="btn btn-primary btn-block">Consulta padrão</a>
                        </div>
                    </div>
                </form>
            </div>
