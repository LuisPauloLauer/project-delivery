                            ...
                            <div class="card-body">
                                <div class="card-body-content align-self-center">
                                    <form action="{{ route('stores.store') }}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-row">
                                            <div class="col">
                                                <label for="inputAffiliate">Afiliado:</label><span class="text-danger col-1">{{$errors->first('affiliate')}}</span>
                                                <select id="idaffiliate" name="affiliate" autofocus data-placeholder="selecione um afiliado para loja..." class="chosen-select">
                                                    <option value=""></option>
                                                    @foreach($listAffiliates as $Affiliate)
                                                        <option value="{{$Affiliate->id}}">{{$Affiliate->fantasy_name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="col">
                                                <label for="inputSegment">Segmento:</label><span class="text-danger col-1">{{$errors->first('segment')}}</span>
                                                <select id="idsegment" name="segment" data-placeholder="selecione um segmento para loja..." class="chosen-select">
                                                    <option value=""></option>
                                            ...
                                            <div class="col">
                                                ...
                                                <select id="idcategorystore" name="categorystore[]" data-placeholder=" selecione uma categoria ou mais categorias para loja..." class="chosen-select" multiple tabindex="4">
                                                    ...
                                                    @foreach($listCategoryStore as $CategoryStore)
                                                        <option value="{{$CategoryStore->id}}">{{$CategoryStore->name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="col">
                                                ...
                                                <input id="idname"  name="name" type="text" class="form-control" >
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="col">
