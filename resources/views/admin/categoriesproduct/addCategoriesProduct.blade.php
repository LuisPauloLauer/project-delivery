                ...
                <div class="row mb-1">
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-left">
                            ...
                            <li class="breadcrumb-item active">Cadastro de Categorias de Kits/Produtos</li>
                        </ol>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="card-body-content align-self-center">
                                    <form action="{{ route('categoriesproduct.store') }}" method="post">
                                        @csrf
                                        <div class="form-row">
                                            <div class="col">
                                            ...
                                            <div class="col">
                                                ...
                                                <input type="text" class="form-control" id="idname" name="name" autofocus>
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="col">
