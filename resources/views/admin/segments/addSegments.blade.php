                ...
                <div class="row mb-1">
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-left">
                            ...
                            <li class="breadcrumb-item active">Cadastro de Segmentos</li>
                        </ol>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="card-body-content align-self-center">
                                    <form  name="formAddSegmento" id="idformAddSegmento" action="{{ route('segments.store') }}" method="post" enctype="multipart/form-data">
                                        @csrf
