                        ...
                        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3">
                            <div class="single-new-pro mb-30 text-center">
                                <div class="product-img">
                                    <a href="{{ route('segment.page', ['segment' => $Segment->slug]) }}">
                                        <img src="{{ $pathImagens }}/segments/{{ $Segment->id}}/large/{{ $Segment->path_image }}"/>
                                    </a>
                                </div>
                                <div class="product-caption">
                                    <h3><a href="{{ route('segment.page', ['segment' => $Segment->slug]) }}">{{ $Segment->name}}</a></h3>
                                </div>
                            </div>
                        </div>
                    @endforeach
