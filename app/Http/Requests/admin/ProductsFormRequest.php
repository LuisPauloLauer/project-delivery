            ...
            if(!empty($this->unit_promotion_price)){
                ...
                if( (!empty($this->id_pdv_store)) && (!empty($this->codigo_pdv_store)) && (!empty($this->codigo_barras_pdv_store)) ){
                    return [
                        ...
                        'id_pdv_store'              => Rule::unique('products', 'id_pdv_store')->where(function ($query) {
                            return $query->where('store', $this->store);
                        }),
                        'codigo_pdv_store'          => Rule::unique('products', 'codigo_pdv_store')->where(function ($query) {
                            return $query->where('store', $this->store);
                        }),
                        'codigo_barras_pdv_store'   => Rule::unique('products', 'codigo_barras_pdv_store')->where(function ($query) {
                            return $query->where('store', $this->store);
                        }),
            ...
            if(!empty($this->unit_promotion_price)){
                ...
                if( (!empty($this->id_pdv_store)) && (!empty($this->codigo_pdv_store)) && (!empty($this->codigo_barras_pdv_store)) ){
                    return [
                        ...
                        'category_product'          => 'required',
                        'id_pdv_store'              => Rule::unique('products', 'id_pdv_store')->where(function ($query) {
                            return $query->where('store', $this->store)->where('id', '<>', $this->idproduct);
                        }),
                        'codigo_pdv_store'          => Rule::unique('products', 'codigo_pdv_store')->where(function ($query) {
                            return $query->where('store', $this->store)->where('id', '<>', $this->idproduct);
                        }),
